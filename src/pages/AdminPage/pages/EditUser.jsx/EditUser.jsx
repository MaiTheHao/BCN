...
function EditUser() {
	...
	return (
		<div className="content-page edit-user">
			<h1>CHỈNH SỬA THÔNG TIN NGƯỜI DÙNG</h1>
			{!data?.UID && (
				<div className="error">
					Không tìm thấy người dùng, hãy quay lại trang thống kê và nhấp vào người dùng cụ thể.
					<Link to={"statistics"}>Quay lại</Link>
				</div>
			)}
